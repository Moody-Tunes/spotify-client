...
class TestSpotifyClient(object):
    ...
    def test_get_audio_features_for_songs_skips_tracks_missing_one_feature(
        ...
        mock_response.json.return_value = {
            'audio_features': [{
                'valence': .5  # Missing danceability and energy features
            }]
        }
        mock_request.return_value = mock_response
    ...
    def test_get_user_tokens(self, mock_request, spotify_client):
        ...
        spotify_auth = spotify_client.get_access_and_refresh_tokens(access_code, redirect_uri)
        ...
        assert spotify_auth.refresh_token == expected_response_data['refresh_token']
